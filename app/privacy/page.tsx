...
const sections = [
  {
    ...
    body: "ระบบจัดเก็บข้อมูลบัญชีผู้ใช้งาน (ชื่อ-นามสกุล อีเมล แผนก ตำแหน่ง) เนื้อหาที่ท่านสร้าง (บทความ กระทู้ คำตอบ ความคิดเห็น) และบันทึกการใช้งานระบบ (Activity Log) เพื่อความปลอดภัยและการตรวจสอบ",
  },
  {
  ...
  },
  {
    ...
    body: "ท่านสามารถขอแก้ไขข้อมูลส่วนตัวได้ที่หน้าโปรไฟล์ และติดต่อศูนย์คอมพิวเตอร์เพื่อขอตรวจสอบหรือลบข้อมูลตามสิทธิที่กฎหมายกำหนด",
  },
];
